...
1. In Python 2, you can speed up your pickle access with cPickle. In Python3, 
importing pickle will automatically use the accelerated version if it is available.
2. TypeError: object of type 'zip' has no len(). Try using list(zip(...) where you have zip(...)
3.
